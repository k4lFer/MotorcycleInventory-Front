...
import { BikeIcon as Motorcycle, Tag, Users, ShoppingCart } from 'lucide-react'
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Motocicletas</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+17% desde el último mes</p>
          </CardContent>
        </Card>
      </div>
    </div>
